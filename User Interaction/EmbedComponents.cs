...
internal static class EmbedComponents
{
	...
	public static Color CreateColorObject(byte R, byte G, byte B)
	{
		return new(R, G, B);
	}
	...
	/// <returns></returns>
	public static EmbedAuthorProperties CreateAuthorObject(string? AuthorText = null, string? IconURL = null, string? TextURL = null)
	{
		return new()
		{
			Name = AuthorText,
	...
	public static EmbedFooterProperties CreateFooterObject(string? FooterText = null, string? IconURL = null)
	{
		return new()
		{
			Text = FooterText,
